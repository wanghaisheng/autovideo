...
LABELS={
    "English":{
        "cookie_path":"cookie json file path",
        "firefox_profile_folder":"firefox profile folder"
    },
    "Chinese":{
        "cookie_path":"cookie json 文件存放位置",
        "firefox_profile_folder":"firefox profile 文件夹"
